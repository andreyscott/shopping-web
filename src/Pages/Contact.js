...
export const Contact = () => {
  // create a value for currentColor
  const currentColor = '#f00'
  // create a value for currentColor
  const currentColor2 = '#0f0'
  return (
    ...
    <div
      ...
      <div className="flex flex-col justify-between">
        ...
        {/* create a anchor tag that link to my gmail account which is andreyscott301@gmail.com */}
        <a href="mailto:andreyscott301@gmail.com" className="text-blue-500">email</a>
</span> instead.
          </div>
        </div>
